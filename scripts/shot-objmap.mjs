...
const MAP = '/assets/maps/DM-W-Grove/DM-W-Grove-2025.obj'
...
BABYLON.SceneLoader.ImportMesh('', '/assets/maps/DM-W-Grove/', 'DM-W-Grove-2025.obj', scene, async (meshes) => {
  try {
    const lj = await (await fetch('/assets/maps/DM-W-Grove/DM-W-Grove-2025.lights.json')).json();
    meshes.forEach(m => {
